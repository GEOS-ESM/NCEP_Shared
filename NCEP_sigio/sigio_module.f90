...
!     iret              Integer(sigio_intkind) output return code
!     ps                Real(sigio_realkind)(ix) input optional surface pressure
!     (Pa)
!     tv                Real(sigio_realkind)(ix,km) input optional virtual
!     temperature (K)
!     pd                Real(sigio_realkind)(ix,km) output optional delta
!     pressure (Pa)
!     pm                Real(sigio_realkind)(ix,km) output optional layer
!     pressure (Pa)
!
...
!                       for idvc=2, nvcoord=2: hybrid interface a and b
!     iret              Integer(sigio_intkind) output return code
!     ps                Real(sigio_dblekind)(ix) input optional surface pressure
!     (Pa)
!     tv                Real(sigio_dblekind)(ix,km) input optional virtual
!     temperature (K)
!     pd                Real(sigio_dblekind)(ix,km) output optional delta
!     pressure (Pa)
!     pm                Real(sigio_dblekind)(ix,km) output optional layer
!     pressure (Pa)
!
...
!                       to sensible Temperature (when cnflag > 0) and the
!                       opposite
...
!     cpi               Real(sigio_realkind)(ntrac) input specific heat at
!     constant
