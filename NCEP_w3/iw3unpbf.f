...
C***********************************************************************
      ...
      INTEGER(SELECTED_INT_KIND(18)) IDSDAX,IDSDMX
...
C     ---> PROCESSES ADPUPA DATA
     ...
     $               QCP(255),QCA(255)
      ...
      INTEGER    ICLA(0:8)
      DOUBLE PRECISION RID,HDR_8(12),VSG_8(255)
      DOUBLE PRECISION  RCT_8(5,255),ARR_8(10,255)
      DOUBLE PRECISION  RAT_8(255),RMORE_8(4),RGP10(255),PRGP10(255)
      DOUBLE PRECISION  RPMSL_8,RPSAL_8
      DIMENSION  OBS(*),RCT(5,255),ARR(10,255)
      DIMENSION  RAT(255),RMORE(4)
...
cppppp-ID
      ...
      IF(SUBSET.EQ.'NC004005')  THEN
         CALL UFBINT(LUNIT,RGP10,1,255,NLEV,'GP10');RGP10=RGP10
...
cppppp
            VSG(1) = 1
            CALL UFBINT(LUNIT,PRGP10,1,255,NLEV,'PRLC')
            PRGP10=PRGP10
...
C     ---> PROCESSES SURFACE DATA
     ...
     $               DOP,POW,HOW,SWD,SWP,SWH,SST,SPG,SPD,SHC,SAS,WES
      ...
      DOUBLE PRECISION RID,UFBINT_8
      DOUBLE PRECISION HDR_8(20),RCT_8(5,255),RRSV_8(3),CLDS_8(4,255),
     $ TMXMNM_8(4,255)
...
C     ---> PROCESSES AIRCRAFT DATA
     ...
     $               QCP(255),QCA(255)
      ...
      DOUBLE PRECISION RID,RCL,UFBINT_8
      DOUBLE PRECISION HDR_8(20),RCT_8(5,255),ARR_8(10,255),RAW_8(1,255)
...
C     ---> PROCESSES SATWIND DATA
     ...
     $               QCP(255),QCA(255)
      ...
      DOUBLE PRECISION RID,UFBINT_8
      DOUBLE PRECISION HDR_8(20),RCT_8(5,255),ARR_8(10,255)
