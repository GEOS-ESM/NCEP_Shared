...
!
!   sfcio_axhead      Deallocate header fields
!     head              Type(sfcio_head) header information
!     iret              Integer(sfcio_intkind) output return code
!
...
!-------------------------------------------------------------------------------
  subroutine sfcio_axhead(head,iret)
    implicit none
    type(sfcio_head),intent(inout):: head
    integer(sfcio_intkind),intent(out):: iret
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    deallocate(head%lpl, head%zsoil, stat=iret)
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end subroutine sfcio_axhead
!-------------------------------------------------------------------------------
